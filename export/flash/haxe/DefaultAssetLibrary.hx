...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/Fighter.png", __ASSET__assets_images_fighter_png);
		type.set ("assets/images/Fighter.png", AssetType.IMAGE);
...
@:keep class __ASSET__assets_images_fighter_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/Fighter.png") class __ASSET__assets_images_fighter_png extends flash.display.BitmapData {}
